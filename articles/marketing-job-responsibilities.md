<properties
                pageTitle="Job Responsibilies for Contacts | Project Madeira" 
...
2. Choose the **Person** action, and then choose the **Job Responsibilities** action.

  The **Contact Job Responsibilities** window opens.
