...
The following table provides an overview of tasks that you typically perfom to close a year and period. These tasks are listed in the order in which they are generally performed.
