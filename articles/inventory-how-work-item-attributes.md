...
3. In the **Item Attribute Values** window, choose the lookup button in the **Attribute** field, and then select an existing item attribute.
...
9. Repeat steps 3 through 8 to define another item attribute filter.
