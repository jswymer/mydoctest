...
To access the Project "Madeira" content pack in Power BI, in the connection window, you must specify the following information:
...
**Getting the URL**  
When you add Project "Madeira" to Power BI, you must specify a URL so Power BI can access data from your company. In the connection window, the URL is referred to as the **OData Feed URL**, and it must have the following format:
