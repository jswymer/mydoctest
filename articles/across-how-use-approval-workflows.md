...
2. To see all your approval requests, In the **Search for Page or Report** field, enter **Approval Request Entries**, and then choose the related link.
...
1. In the **Search for Page or Report** field, enter **Requests to Approve**, and then choose the related link.
...
1. In the **Search for Page or Report** field, enter **Overdue Approval Requests**, and then choose the related link.
