<properties
                pageTitle="How to: Categorize Items| Project “Madeira”"
...
To help you and customers find products by characteristics, you can assign item attributes to items and also to item categories. For more information, see [How to: Work with Item Attributes](inventory-how-work-item-attributes.md). 
...
3. In the **Item Category Card** window, on the **General** FastTab, fill the fields as necessary. Choose a field to read a short description of the field or link to more information.
