...
1. In the **Search for Page or Report** field, enter **Vendor Ledger Entries**, and then choose the related link.
...
1. In the **Search for Page or Report** field, enter **Incoming Documents**, and then choose the related link.
