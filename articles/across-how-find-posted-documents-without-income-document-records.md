...
2. Select a line for a G/L account for whose general ledger entries you want to see posted purchase and sales documents without incoming document records, and thenj choose the **Posted Documents without Incoming Document** action.
