...
For detailed information and to adjust the application rules that govern the automatic application, see [How to: Set Up Rules for Automatic Application of Payments](https://msdn.microsoft.com/en-us/library/dn789556.aspx) in the MSDN Library .
