...
In Financials, some things will be familiar to you, and other things might be unfamiliar. In the demonstration company, you can see visual guides that explain core functionality. These guides let you try out daily tasks such as making a sales invoice and viewing a report. When you want to explore Financials on your own, you can always go back to the Getting Started tour by launching it from the Home page.
