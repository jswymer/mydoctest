...
|Set up an external service that enables you to import bank statements as bank feeds for payment application and bank reconciliation.|[How to: Set Up the Investnet YodleesBank Feeds Service](bank-how-setup-bank-statement-service.md)|
