...
Customer cards hold the information that is required to sell products to the customer. For more information, see [How to: Invoice Sales](sales-how-invoice-sale.md) and [How to: Register New Products](inventory-how-register-new-products.md).
