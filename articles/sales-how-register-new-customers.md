...
4. Close the window. A new customer card opens with some fields filled with information from the template.  
...
5. When you have completed the new customer template, close the window.
