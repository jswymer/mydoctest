...
1. Clone the repo:
   ```
   git clone https://github.com/Microsoft/smbmadeira-content-pr.git
   ```
...
4. Wait for a moment and your changes will be automatically published to: https://ppe.msdn.microsoft.com/en-us/madeira/docs/madeira-get-started?branch=master
...
Some articles must have a different value for the ms.topic tag. For more information, see https://github.com/Azure/azure-content/blob/master/contributor-guide/article-metadata.md#attributes-and-values-for-the-tags-section.
